...
from utils.ratelimit import register_limiter, login_limiter, forgot_password_limiter
...
def check_username_available(username):
    ...
    from utils.validation import validate_website_username
...
def register(username, password, confirm, verify_code, captcha_input, captcha_id,
    ...
    from utils.validation import validate_website_username, validate_password_strength
