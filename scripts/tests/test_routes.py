...
ROUTES = [
    ...
    ('/music/my/favorites', 'GET', [302, 401],   True,     '我的收藏页（未登录跳转登录页）'),
    ('/music/999999/favorite', 'POST', [302, 401], True,   '收藏/取消收藏音频（未登录跳转登录页）'),
    ('/music/999999/tags', 'POST', [302, 401],   True,     '编辑音频标签（未登录跳转登录页）'),
